...
public class ConfigDemo {
    ...
    //获取方式（复杂的请用这种方式）
    //
    public String nameuser_2 = JustSimple.cfg().get("username");

    public Properties dbcfg = JustSimple.cfg().getProp("demo8.test");

    public Properties test2(){
        return JustSimple.cfg().getProp("demo8.test");
    }

    public ConfigDemo(){
        JustSimple.cfg().onChange((k, v)->{
