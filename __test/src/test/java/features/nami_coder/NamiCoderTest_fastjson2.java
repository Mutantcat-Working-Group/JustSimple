...
import org.mutantcat.justsimple.nami.coder.fastjson2.Fastjson2Decoder;
import org.mutantcat.justsimple.nami.coder.fastjson2.Fastjson2Encoder;
...
//    @Test
//    public void test_fastjson2_err() {
//        //err
//        Result err_rst = new Result(200, json_err.getBytes(StandardCharsets.UTF_8));
//        try {
//            Object rst = Fastjson2Decoder.instance.decode(err_rst, UserModel.class);
...
//    }
    ...
    @Test
    public void test_fastjson2_bean() {
        //bean
        Result usr_rst = new Result(200, json_usr.getBytes(StandardCharsets.UTF_8));
        Object usr_obj = Fastjson2Decoder.instance.decode(usr_rst, UserModel.class);
        ...
        Object usr_obj_ary = Fastjson2Decoder.instance.decode(usr_rst_ary, List.class);
        ...
        //null
        usr_rst = new Result(200, Fastjson2Encoder.instance.encode(null));
        usr_obj = Fastjson2Decoder.instance.decode(usr_rst, UserModel.class);

        assert usr_obj == null;
    }

    @Test
    public void test_fastjson2_bean2() {
        //bean
