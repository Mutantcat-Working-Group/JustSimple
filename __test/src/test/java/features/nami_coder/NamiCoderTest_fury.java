...
import org.mutantcat.justsimple.nami.coder.fury.FuryDecoder;
import org.mutantcat.justsimple.nami.coder.fury.FuryEncoder;
 ...
 */
public class NamiCoderTest_fury {
...
//    }
    ...
    public void test_fury_bean() {
        ...
        //null
        usr_rst = new Result(200, FuryEncoder.instance.encode(null));
        usr_obj = FuryDecoder.instance.decode(usr_rst, UserModel.class);
