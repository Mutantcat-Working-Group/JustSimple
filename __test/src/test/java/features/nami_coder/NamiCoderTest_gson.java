 ...
 * 
 * @author cqyhm
 * @since 2025年12月30日20:28:02
 */
public class NamiCoderTest_gson {
    ...
    public void test_bean() throws Throwable{
        ...
        Object usr_obj = decoder.decode(usr_rst, UserModel.class);
    ...
    @Test
    public void test_bean2() throws Throwable{
        //bean
...
//    }
    ...
    public void test_null() throws Throwable{
        //null
        Result usr_rst = new Result(200, encoder.encode(null));
        Object usr_obj = decoder.decode(usr_rst, UserModel.class);
