...
public class ConditionTest {
    ...
    @Test
    public void test2() {
        assert JustSimple.context().getBean(ConditionCom11A.class) == null;
        assert JustSimple.context().getBean(ConditionCom12A.class) == null;

        assert JustSimple.context().getBean(ConditionCom11B.class) != null;
        assert JustSimple.context().getBean(ConditionCom12B.class) != null;
    }

    @Test
    public void test3() {
        assert JustSimple.context().getBean(ConditionBean11A.class) == null;
        assert JustSimple.context().getBean(ConditionBean12A.class) == null;

        assert JustSimple.context().getBean(ConditionBean11B.class) != null;
        assert JustSimple.context().getBean(ConditionBean12B.class) != null;
    }

    @Test
    public void test4(){
        assert JustSimple.context().getBean(Construction1Com11B.class) != null;
        assert JustSimple.context().getBean(Construction1Com11B2.class) != null;
    }
}
