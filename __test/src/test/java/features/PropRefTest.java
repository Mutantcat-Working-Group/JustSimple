...
public class PropRefTest {
    ...
    public void test() {
        ...
        System.out.println("JustSimple.cfg() each.a: " + JustSimple.cfg().get("each.a"));
    ...
    @Test
    public void test2() {
        String test_aaa = JustSimple.cfg().get("demo6.test.aaa");
        int test_bbb = JustSimple.cfg().getInt("demo6.test.bbb", 0);
    ...
    @Test
    public void test3() {
        String test_ccc = JustSimple.cfg().get("demo6.test.ccc");//${.bbb}
