...
public class RuntimeNativeMetadataTest {
    ...
    public void testReflectionJson() throws NoSuchMethodException, NoSuchFieldException, IOException {
        ...
        metadata.registerReflection(JustSimple.class, hint -> {
                    hint.getMemberCategories().add(MemberCategory.PUBLIC_FIELDS);
                    hint.getMemberCategories().add(MemberCategory.DECLARED_FIELDS);
                    hint.setReachableType("org.mutantcat.justsimple.JustSimple");
                })
                .registerMethod(JustSimple.class.getMethod("version"), ExecutableMode.INVOKE)
                .registerField(JustSimple.class.getDeclaredField("encoding"));

        Constructor<?>[] constructors = JustSimple.class.getConstructors();
    ...
    public void testResourceJson() throws IOException {
        ...
        metadata.registerResourceInclude("/")
                ...
                .registerResourceInclude("META-INF/justsimple")
                .registerResourceInclude("META-INF/justsimple/.*")
                .registerResourceInclude("META-INF/justsimple_def/.*");
