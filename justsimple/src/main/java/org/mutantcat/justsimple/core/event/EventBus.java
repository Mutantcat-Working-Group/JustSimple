...
import org.mutantcat.justsimple.core.exception.EventException;
 ...
 * 事件总线（内部类，外部不要使用）
 *
 * @see org.mutantcat.justsimple.core.AppContext#start()
 * @see org.mutantcat.justsimple.JustSimpleApp#onEvent(Class, EventListener)
 * */
