...
import org.mutantcat.justsimple.core.exception.ConvertException;
import org.mutantcat.justsimple.core.handle.Context;
import org.mutantcat.justsimple.core.wrap.VarSpec;
...
public class ConvertUtil {
    ...
    public static Object tryTo(Class<?> type, String val) {
        ...
        if (JustSimple.app() != null) {
            Converter converter = JustSimple.app().converters().find(String.class, type);
            if (converter != null) {
