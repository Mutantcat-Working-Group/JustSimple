...
public class ProxyBinder {
    ...
    static {
        ...
        global = ClassUtil.tryInstance("org.mutantcat.justsimple.extend.impl.ProxyBinderExt");
    ...
    public void binding(BeanWrap bw){
        if (NativeDetector.isNotAotRuntime()) {
            throw new IllegalStateException("Missing plugin dependency: 'justsimple.proxy'");
        }
    }
}
