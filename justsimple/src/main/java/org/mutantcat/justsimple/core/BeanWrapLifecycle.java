...
import org.mutantcat.justsimple.annotation.Destroy;
import org.mutantcat.justsimple.annotation.Init;
...
import org.mutantcat.justsimple.core.util.IndexUtil;
...
class BeanWrapLifecycle implements LifecycleBean {
    ...
    public boolean check() {
        ...
        if (initMethod == null && destroyMethod == null) {
            //如果不是 jdk 的类（否则没必要）
            if (clzEggg.getTypeEggg().isJdkType() == false) {
                //找查注解函数
