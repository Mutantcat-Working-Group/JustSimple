...
public class ResourceUtil {
    ...
    public static String getResourceAsString(String name) throws IOException {
        return getResourceAsString(AppClassLoader.global(), name, JustSimple.encoding());
    }
    ...
    public static String getResourceAsString(URL url) throws IOException {
        return getResourceAsString(url, JustSimple.encoding());
    }
    ...
    public static String findResourceAsString(String uri) throws IOException {
        ...
        if (url != null) {
            try (InputStream in = url.openStream()) {
                return IoUtil.transferToString(in, JustSimple.encoding());
            }
        } else {
            return null;
        }
