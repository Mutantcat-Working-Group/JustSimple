...
import org.mutantcat.justsimple.core.PropsConverter;
...
public abstract class Context {
    ...
    public SessionState sessionState(boolean create) {
        if (sessionState == null && create) {
            sessionState = JustSimple.app().chains().getSessionState(this);
        }
    ...
    public void forward(String pathNew) {
        ...
        try {
            //直接执行处理器（省去了过滤）
            JustSimple.app().handler().handle(this);
    ...
    public final void render(Object obj) throws Throwable {
        ...
        JustSimple.app().renders().render(obj, this);
    }
    ...
    public final String renderAndReturn(Object obj) throws Throwable {
        return JustSimple.app().renders().renderAndReturn(obj, this);
    }
    ...
    public void returnValue(Object obj) throws Throwable {
        ...
        if (returnHandler == null) {
            returnHandler = JustSimple.app().chains().getReturnHandler(this, obj.getClass());
        }
