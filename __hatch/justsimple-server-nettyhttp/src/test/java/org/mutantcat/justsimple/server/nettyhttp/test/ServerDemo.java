 ...
 */
package org.mutantcat.justsimple.server.nettyhttp.test;

import java.net.InetSocketAddress;
import org.mutantcat.justsimple.JustSimple;
import org.mutantcat.justsimple.annotation.JustSimpleMain;
import org.mutantcat.justsimple.server.nettyhttp.NettyHttpServer;
...
public class ServerDemo {
    ...
    public static class ServerImpl implements LifecycleBean {
        ...
        public void start() throws Throwable {
            _server = new NettyHttpServer(new InetSocketAddress(JustSimple.cfg().serverPort()),
                    HttpServerProps.getInstance(), JustSimple.app()::tryHandle);
            _server.start(null, JustSimple.cfg().serverPort());
        }
