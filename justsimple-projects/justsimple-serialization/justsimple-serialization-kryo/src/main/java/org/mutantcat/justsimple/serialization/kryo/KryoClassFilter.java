 ...
 */
package org.mutantcat.justsimple.serialization.kryo;
...
public class KryoClassFilter {
    ...
    public static KryoClassFilter unrestricted() {
        KryoClassFilter f = new KryoClassFilter();
        f.allowAll = true;
        return f;
    }

    public KryoClassFilter allow(String pattern) {
    ...
    public KryoClassFilter deny(String pattern) {
        if (pattern != null && pattern.length() > 0) {
    ...
    public KryoClassFilter allowAll(boolean allowAll) {
