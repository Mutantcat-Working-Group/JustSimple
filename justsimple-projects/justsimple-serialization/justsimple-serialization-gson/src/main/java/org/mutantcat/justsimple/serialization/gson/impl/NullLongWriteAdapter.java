 ...
 */
package org.mutantcat.justsimple.serialization.gson.impl;
...
public class NullLongWriteAdapter extends TypeAdapter<Long> {
    private JsonProps jsonProps;

    public NullLongWriteAdapter(JsonProps jsonProps) {
