...
import org.mutantcat.justsimple.serialization.gson.GsonStringSerializer;
...
public class TestApp {
    public static void main(String[] args) {
        JustSimple.start(TestApp.class, args, app -> {
            ...
            app.context().getWrapAsync(GsonStringSerializer.class, bw -> initMvcJsonCustom((GsonStringSerializer) bw.raw()));
        });
    }
     ...
     */
    private static void initMvcJsonCustom(GsonStringSerializer factory) {
        //通过转换器，做简单类型的定制
