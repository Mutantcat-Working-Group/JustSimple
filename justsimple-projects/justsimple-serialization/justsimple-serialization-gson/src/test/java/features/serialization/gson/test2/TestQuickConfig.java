 ...
 */
package features.serialization.gson.test2;

import features.serialization.gson.model.OrderDo;
...
import org.mutantcat.justsimple.serialization.gson.GsonEntityConverter;
...
public class TestQuickConfig {
    @Inject
    GsonEntityConverter entityConverter;
