...
import org.mutantcat.justsimple.serialization.fastjson2.Fastjson2StringSerializer;
...
public class DemoApp {
    ...
    private static void initMvcJsonCustom(Fastjson2StringSerializer serializer) {
        ...
        serializer.getSerializeConfig().addFeatures(JSONWriter.Feature.WriteMapNullValue);
    }
}
