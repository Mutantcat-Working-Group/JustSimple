 ...
 */
package demo.serialization.fastjson.demo2;

import com.alibaba.fastjson.serializer.SerializeWriter;
import com.alibaba.fastjson.serializer.SerializerFeature;
import org.mutantcat.justsimple.JustSimple;
import org.mutantcat.justsimple.serialization.fastjson.FastjsonStringSerializer;
...
public class DemoApp {
    ...
    private static void initMvcJsonCustom(FastjsonStringSerializer factory) {
        //示例1：通过转换器，做简单类型的定制
        ...
        factory.getSerializeConfig().addFeatures(SerializerFeature.WriteMapNullValue);
    }
}
