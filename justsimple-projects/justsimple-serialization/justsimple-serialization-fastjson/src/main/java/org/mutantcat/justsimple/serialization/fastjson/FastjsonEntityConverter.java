 ...
 */
package org.mutantcat.justsimple.serialization.fastjson;
...
import org.mutantcat.justsimple.serialization.AbstractStringEntityConverter;
 ...
 * @since 3.6
 */
public class FastjsonEntityConverter extends AbstractStringEntityConverter<FastjsonStringSerializer> {
    public FastjsonEntityConverter(FastjsonStringSerializer serializer) {
        super(serializer);

        serializer.getSerializeConfig().addFeatures(SerializerFeature.BrowserCompatible);
    }
    ...
    protected Object changeValue(Context ctx, ParamWrap pWrap, int pIdx, Class<?> pt, LazyReference bodyRef) throws Throwable {
        ...
        if (bodyObj instanceof JSONObject) {
            ...
            if (pt.isPrimitive() || pt.getTypeName().startsWith("java.lang.")) {
                ...
                //支持泛型的转换 如：Map<T>
                return tmp.toJavaObject(pWrap.getGenericType());
            }
        }
