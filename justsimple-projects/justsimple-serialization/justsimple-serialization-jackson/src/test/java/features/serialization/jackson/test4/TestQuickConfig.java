 ...
 */
package features.serialization.jackson.test4;

import features.serialization.jackson.model.CustomDateDo;
import features.serialization.jackson.model.UserDo;
...
public class TestQuickConfig {
    ...
    public void date2() throws Throwable {
        ...
        //完美
        assert "{\"date\":\"2023-01-16 17:39:53\",\"date2\":\"2023-01-16\",\"val_1\":null}".equals(output);
    }
}
