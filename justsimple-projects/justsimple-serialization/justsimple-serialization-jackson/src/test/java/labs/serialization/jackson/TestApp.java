...
import org.mutantcat.justsimple.serialization.jackson.JacksonStringSerializer;
...
public class TestApp {
    public static void main(String[] args) {
        JustSimple.start(TestApp.class, args, app -> {
            ...
            app.context().getWrapAsync(JacksonStringSerializer.class, bw -> initMvcJsonCustom((JacksonStringSerializer) bw.raw()));
        });
    }
