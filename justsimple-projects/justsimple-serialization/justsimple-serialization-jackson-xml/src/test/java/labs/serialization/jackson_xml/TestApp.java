...
import org.mutantcat.justsimple.serialization.jackson.xml.JacksonXmlStringSerializer;
...
public class TestApp {
    public static void main(String[] args) {
        JustSimple.start(TestApp.class, args, app -> {
            ...
            app.context().getWrapAsync(JacksonXmlStringSerializer.class, bw -> initMvcJsonCustom((JacksonXmlStringSerializer) bw.raw()));
        });
    }
     ...
     */
    private static void initMvcJsonCustom(JacksonXmlStringSerializer factory) {
        //通过转换器，做简单类型的定制
