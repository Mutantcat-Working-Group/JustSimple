 ...
 */
package features.serialization.jackson_xml.test2;

import features.serialization.jackson_xml.model.OrderDo;
import features.serialization.jackson_xml.model.UserDo;
...
import org.mutantcat.justsimple.serialization.jackson.xml.JacksonXmlEntityConverter;
...
public class TestQuickConfig {
    @Inject
    JacksonXmlEntityConverter entityConverter;
    ...
    public void hello2() throws Throwable{
        ...
        //完美
        assert "<UserDo><b1>1</b1><d1>1.0</d1><map1><time>2023-01-16 17:39:53</time><long>12</long><int>12</int></map1><n1>1</n1><s1>noear</s1><type>MANAGE</type></UserDo>".equals(output);
    }
