 ...
 */
package features.serialization.fory.test0;

import features.serialization.fory.model.UserDo;
...
import org.mutantcat.justsimple.serialization.fory.ForyEntityConverter;
...
public class BaseTest {
    ...
    public void hello2() throws Throwable {
        ...
        ForyEntityConverter entityConverter = new ForyEntityConverter(new ForyBytesSerializer());
        entityConverter.write(userDo, ctx);

        ForyBytesSerializer serializer = new ForyBytesSerializer();
