 ...
 */
package org.mutantcat.justsimple.logging;
...
public final class AppenderHolder {
    ...
    public AppenderHolder(String name, Appender real, boolean printed) {
        ...
        if (JustSimple.app() != null) {
            String levelStr = JustSimple.cfg().get("justsimple.logging.appender." + getName() + ".level");

            //设置级别
            setLevel(Level.of(levelStr, real.getDefaultLevel()));

            //是否启用
            enable = JustSimple.cfg().getBool("justsimple.logging.appender." + getName() + ".enable", true);
