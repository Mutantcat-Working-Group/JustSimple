...
import org.mutantcat.justsimple.logging.event.AppenderBase;
import org.mutantcat.justsimple.logging.event.LogEvent;
...
public class JustSimpleAppenderTest {
    ...
    private JustSimpleAppender startedAppender() {
    ...
    public void test_level_mapping() {
        ...
        JustSimpleAppender appender = startedAppender();
        ...
        assertEquals(org.mutantcat.justsimple.logging.event.Level.TRACE, capture.events.get(0).getLevel());
        assertEquals(org.mutantcat.justsimple.logging.event.Level.DEBUG, capture.events.get(1).getLevel());
        // INFO 无显式 case，走默认 INFO
        assertEquals(org.mutantcat.justsimple.logging.event.Level.INFO, capture.events.get(2).getLevel());
        assertEquals(org.mutantcat.justsimple.logging.event.Level.WARN, capture.events.get(3).getLevel());
        assertEquals(org.mutantcat.justsimple.logging.event.Level.ERROR, capture.events.get(4).getLevel());
