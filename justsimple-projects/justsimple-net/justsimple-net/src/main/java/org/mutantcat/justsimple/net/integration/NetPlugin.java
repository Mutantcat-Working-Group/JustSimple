 ...
 */
package org.mutantcat.justsimple.net.integration;
...
import org.mutantcat.justsimple.net.socketd.SocketdRouter;
...
import org.mutantcat.justsimple.net.websocket.WebSocketRouter;
import org.mutantcat.justsimple.net.websocket.listener.ContextPathWebSocketListener;
...
public class NetPlugin implements Plugin {
    ...
    public void start(AppContext context) throws Throwable {
        ...
        context.lifecycle((() -> {
            //尝试设置 context-path
            if (Utils.isNotEmpty(JustSimple.cfg().serverContextPath())) {
    ...
    private void serverEndpointBuild(Class<?> clz, BeanWrap bw, ServerEndpoint anno) {
        String path = JustSimple.cfg().getByTmpl(anno.value()); //支持属性配置
