 ...
 */
package org.mutantcat.justsimple.net.http;

import org.mutantcat.justsimple.JustSimple;
import org.mutantcat.justsimple.net.http.impl.HttpUtilsFactoryDefault;
...
public class HttpConfiguration {
    ...
    /**
     * 默认 User-Agent（默认 "justsimple-httputils/" + JustSimple.version()）
     * <p>置 null 表示不发送默认 UA（由底层实现自行补充，如 Java/x、okhttp/x）</p>
     */
    private static volatile String userAgent = "justsimple-http/" + JustSimple.version();
