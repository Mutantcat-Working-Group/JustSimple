...
import org.mutantcat.justsimple.net.http.HttpResponseException;
...
public class JdkHttpResponse implements HttpResponse {
        ...
        try {
            ...
            if (charset == null) {
                if (utils.charset() != null) {
                    ...
                    charset = Charset.forName(JustSimple.encoding());
                }
            }
    ...
    public <T> T bodyAsBean(Type type) throws IOException {
        if (String.class == utils.serializer().dataType()) {
            ...
            throw new JustSimpleException("Invalid serializer type!");
        }
    }
