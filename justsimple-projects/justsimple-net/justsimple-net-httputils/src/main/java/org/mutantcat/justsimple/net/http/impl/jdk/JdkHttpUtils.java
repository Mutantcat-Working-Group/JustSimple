 ...
 */
package org.mutantcat.justsimple.net.http.impl.jdk;
...
import org.mutantcat.justsimple.net.http.HttpException;
import org.mutantcat.justsimple.net.http.HttpResponse;
import org.mutantcat.justsimple.net.http.HttpUtils;
import org.mutantcat.justsimple.net.http.impl.AbstractHttpUtils;
import org.mutantcat.justsimple.net.http.impl.HttpSslSupplierDefault;
import org.mutantcat.justsimple.net.http.impl.HttpStream;
import org.mutantcat.justsimple.net.http.impl.HttpUploadFile;
...
public class JdkHttpUtils extends AbstractHttpUtils implements HttpUtils {
    ...
    protected HttpURLConnection getClient(String newUrl) throws IOException {
        ...
        _builder.setInstanceFollowRedirects(false);
