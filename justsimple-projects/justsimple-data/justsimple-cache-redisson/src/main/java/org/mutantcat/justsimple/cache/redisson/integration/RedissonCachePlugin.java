 ...
 */
package org.mutantcat.justsimple.cache.redisson.integration;

import org.mutantcat.justsimple.core.AppContext;
import org.mutantcat.justsimple.core.Plugin;
import org.mutantcat.justsimple.data.cache.CacheFactory;
import org.mutantcat.justsimple.data.cache.CacheLib;

/**
 * @author noear
 * @since 1.7
 */
public class RedissonCachePlugin implements Plugin {
    @Override
