 ...
 */
package org.mutantcat.justsimple.scheduling.command;
...
public class CommandManager {
    ...
    public static CommandManager getInstance() {
        ...
        return JustSimple.context().attachOf(CommandManager.class, CommandManager::new);
    }
    ...
    public void executeAll() {
        ...
        for (Map.Entry<String, CommandExecutor> kv : executorMap.entrySet()) {
            if (JustSimple.cfg().argx().containsKey(kv.getKey())) {
