 ...
 */
package org.mutantcat.justsimple.validation.integration;

import org.mutantcat.justsimple.JustSimple;
import org.mutantcat.justsimple.core.AppContext;
import org.mutantcat.justsimple.core.Plugin;
import org.mutantcat.justsimple.validation.BeanValidateInterceptor;
import org.mutantcat.justsimple.validation.BeanValidator;
import org.mutantcat.justsimple.validation.ValidatorFailureHandler;
import org.mutantcat.justsimple.validation.ValidatorManager;
import org.mutantcat.justsimple.validation.annotation.*;
...
public class ValidPlugin implements Plugin {
    ...
    public void start(AppContext context) {
        ValidatorManager.VALIDATE_ALL = JustSimple.cfg().getBool("justsimple.validation.validateAll", false);
