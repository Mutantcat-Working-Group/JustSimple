...
import org.mutantcat.justsimple.configurationprocessor.metadata.JsonMarshaller;
...
public class MetadataStore {
    ...
    static final String METADATA_PATH = "META-INF/justsimple/justsimple-configuration-metadata.json";

    private static final String ADDITIONAL_METADATA_PATH = "META-INF/justsimple/additional-justsimple-configuration-metadata.json";
