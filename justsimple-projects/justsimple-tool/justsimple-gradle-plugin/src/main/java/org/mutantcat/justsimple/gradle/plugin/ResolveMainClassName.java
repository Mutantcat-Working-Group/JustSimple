...
import org.mutantcat.justsimple.gradle.tools.MainClassFinder;
import org.mutantcat.justsimple.gradle.util.IoUtils;
...
public class ResolveMainClassName extends DefaultTask {
    ...
    private static final String JUSTSIMPLE_APPLICATION_CLASS_NAME = "org.mutantcat.justsimple.annotation.JustSimpleMain";
    ...
    private String findMainClass(File file) {
        try {
            return MainClassFinder.findSingleMainClass(file, JUSTSIMPLE_APPLICATION_CLASS_NAME);
