...
public class Constant {
    ...
    public static final String JAR_TOOL = "JustSimple-Jar-Build-Tool";

    public static final String JAR_TOOL_VALUE = "JustSimple-Jar-Plugin";

    public static final String START_CLASS = "Start-Class";

    public static final String START_CLASS_ANNOTATION = "org.mutantcat.justsimple.annotation.JustSimpleMain";
