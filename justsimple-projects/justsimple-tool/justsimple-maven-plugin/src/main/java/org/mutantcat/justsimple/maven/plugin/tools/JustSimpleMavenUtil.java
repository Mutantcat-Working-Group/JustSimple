 ...
 */
package org.mutantcat.justsimple.maven.plugin.tools;
...
import org.mutantcat.justsimple.maven.plugin.Constant;
 ...
 */
public class JustSimpleMavenUtil {
            ...
            while (!stack.isEmpty()) {
                ...
                if (itemFile.isFile()) {
                    try {
                        ...
                        inputStream.close();
                        String justsimpleMain = getJustSimpleMainClass(ctClass, mains);
                        //有注解的为主类
                        if (justsimpleMain != null) {
                            logger.info("Checked startup class: " + ctClass.getName());
                            return justsimpleMain;
                        }
    ...
    private static String getJustSimpleMainClass(CtClass ctClass, List<String> mains) throws NotFoundException {
