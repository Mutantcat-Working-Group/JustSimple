 ...
 */
package org.mutantcat.justsimple.maven.plugin.tools.jar;



import org.mutantcat.justsimple.maven.plugin.tools.data.RandomAccessData;
import org.mutantcat.justsimple.maven.plugin.tools.data.RandomAccessDataFile;
...
import static org.mutantcat.justsimple.maven.plugin.Constant.HEAD_PACKAGE;
...
public class JarFile extends java.util.jar.JarFile {
	...
	private static final String HANDLERS_PACKAGE = HEAD_PACKAGE;
	...
	void setupEntryCertificates(JarEntry entry) {
		...
		try {
			JarInputStream inputStream = new JarInputStream(
					getData().getInputStream(RandomAccessData.ResourceAccess.ONCE));
			try {
