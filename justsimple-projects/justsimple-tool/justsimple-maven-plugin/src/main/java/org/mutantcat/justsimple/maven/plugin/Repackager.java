...
import org.mutantcat.justsimple.maven.plugin.tools.tool.*;
...
import static org.mutantcat.justsimple.maven.plugin.Constant.*;
...
public class Repackager {
    ...
    public Repackager(File source, Log logger, String mainClass) throws Exception {
        ...
        this.mainClass = JustSimpleMavenUtil.getStartClass(getFile(), mainClass, logger);
