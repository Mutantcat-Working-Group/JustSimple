...
import org.mutantcat.justsimple.maven.plugin.filter.Exclude;
import org.mutantcat.justsimple.maven.plugin.filter.ExcludeFilter;
import org.mutantcat.justsimple.maven.plugin.filter.FilterableDependency;
import org.mutantcat.justsimple.maven.plugin.filter.Include;
import org.mutantcat.justsimple.maven.plugin.filter.IncludeFilter;
import org.mutantcat.justsimple.maven.plugin.filter.MatchingGroupIdFilter;
import org.mutantcat.justsimple.maven.plugin.tools.tool.ArtifactsLibraries;
import org.mutantcat.justsimple.maven.plugin.tools.tool.Libraries;
...
public class RepackageMojo extends AbstractMojo {
     ...
     * @since 1.2.0
     */
    @Parameter(property = "justsimple.includes")
     ...
     * @since 1.1.0
     */
    @Parameter(property = "justsimple.excludes")
     ...
     * @since 1.1.0
     */
    @Parameter(property = "justsimple.excludeGroupIds", defaultValue = "")
