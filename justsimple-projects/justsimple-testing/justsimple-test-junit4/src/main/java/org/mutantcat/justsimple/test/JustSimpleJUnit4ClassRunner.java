...
public class JustSimpleJUnit4ClassRunner extends BlockJUnit4ClassRunner {
    private AppContext appContext;
    private Class<?> klass;

    public JustSimpleJUnit4ClassRunner(Class<?> klass) throws InitializationError {
        super(klass);
    }
    ...
    protected void afterAllDo() {
        if (klass != null && JustSimple.app() != null) {
            if (klass.equals(JustSimple.app().source())) {
                if (JustSimple.app() instanceof SimpleJustSimpleApp) {
                    ((SimpleJustSimpleApp) JustSimple.app()).stop();
                }
            }
        }
    }
