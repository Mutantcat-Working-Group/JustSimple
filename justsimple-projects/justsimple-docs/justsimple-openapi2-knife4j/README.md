justsimple 集成 swagger2 + knife4j , 按UI规范生成相应的 Swagger Json。目前处于试验中
...
```yaml
justsimple.docs:
  discover:  #(发现配置，需要引入 justsimple cloud 发现服务插件)，可选
    enabled: true
  ...
  routes:
    ...
    - id: adminApi  #(本地接口文档)，配置风格
      ...
      info: #可选
        ...
        license: #可选
          name: "demo"
          url: "https://gitee.com/noear/justsimple/blob/master/LICENSE"
```
        ...
        return new DocDocket()
                ...
                .info(new ApiInfo().title("在线文档")
                        ...
                        .contact(new Contact().name("demo")
                                .url("https://gitee.com/noear/justsimple")
