 ...
 */
package com.github.xiaoymin.knife4j.justsimple.extension;

import com.github.xiaoymin.knife4j.justsimple.settings.OpenApiExtendSetting;
import com.github.xiaoymin.knife4j.justsimple.settings.OpenApiSetting;
import org.mutantcat.justsimple.JustSimple;
import org.mutantcat.justsimple.Utils;
import org.mutantcat.justsimple.docs.models.ApiVendorExtension;
...
public class OpenApiExtensionResolver {
    ...
    public OpenApiExtensionResolver() {
        setting = JustSimple.cfg().toBean("knife4j", OpenApiSetting.class);
        extendSetting = JustSimple.cfg().toBean("knife4j.setting", OpenApiExtendSetting.class);
