 ...
 * */
class MultipartUtil {
    public static void buildParamsAndFiles(JustSimpleServletContext ctx, MultiMap<UploadedFile> filesMap) {
    ...
    private static boolean hasLargerEx(Throwable e) {
        if (e != null) {
            if (e.getMessage() != null) {
                if (e.getMessage().contains(" large") || e.getMessage().contains(" exceed")) {
                    return true;
                }
            }
