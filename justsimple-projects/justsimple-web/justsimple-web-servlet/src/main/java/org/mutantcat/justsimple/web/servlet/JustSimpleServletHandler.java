...
/**
 * Servlet Handler，适配为 JustSimple 入口
 *
 * @author noear
 * @since 1.2
 * */
public class JustSimpleServletHandler extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        JustSimpleServletContext ctx = new JustSimpleServletContext(request, response, useLimitStream());
