...
import org.mutantcat.justsimple.net.websocket.WebSocketBase;
 ...
 * @since 2.6
 */
public class JustSimpleWebSocketEndpoint extends Endpoint {
            ...
            for (String path : paths) {
                if (path.startsWith("/")) {
                    ServerEndpointConfig endpointConfig = ServerEndpointConfig.Builder
                            .create(JustSimpleWebSocketEndpoint.class, path)
                            .build();
