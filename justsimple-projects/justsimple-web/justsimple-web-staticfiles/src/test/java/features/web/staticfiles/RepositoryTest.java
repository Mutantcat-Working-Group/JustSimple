...
import org.mutantcat.justsimple.web.staticfiles.StaticLocation;
import org.mutantcat.justsimple.web.staticfiles.StaticRepository;
...
public class RepositoryTest {
    ...
    public void testClassPathStaticRepositoryInDebugMode() throws Exception {
        File tempDir = new File(System.getProperty("java.io.tmpdir"), "justsimple_cp_debug_" + System.currentTimeMillis());
        tempDir.mkdirs();
    ...
    public void testFileStaticRepository() throws Exception {
        File tempDir = new File(System.getProperty("java.io.tmpdir"), "justsimple_repo_test_" + System.currentTimeMillis());
        tempDir.mkdirs();
        tempDir.deleteOnExit();
    ...
    public void testExtendStaticRepository() throws Exception {
        File tempDir = new File(System.getProperty("java.io.tmpdir"), "justsimple_extend_test_" + System.currentTimeMillis());
        tempDir.mkdirs();
        tempDir.deleteOnExit();
