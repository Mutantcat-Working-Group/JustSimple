...
public class StaticConfigTest {
    ...
    public void testStaticConfig() {
        ...
        assertEquals("justsimple.staticfiles.enable", StaticConfig.PROP_ENABLE);
        assertEquals("justsimple.staticfiles.cacheMaxAge", StaticConfig.PROP_CACHE_MAX_AGE);
        assertEquals("justsimple.staticfiles.mappings", StaticConfig.PROP_MAPPINGS);
