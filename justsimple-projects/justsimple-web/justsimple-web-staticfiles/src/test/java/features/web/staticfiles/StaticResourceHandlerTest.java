...
import org.mutantcat.justsimple.core.util.DateUtil;
import org.mutantcat.justsimple.server.prop.GzipProps;
import org.mutantcat.justsimple.test.JustSimpleTest;
import org.mutantcat.justsimple.web.staticfiles.StaticConfig;
import org.mutantcat.justsimple.web.staticfiles.StaticMappings;
import org.mutantcat.justsimple.web.staticfiles.StaticResourceHandler;
...
public class StaticResourceHandlerTest {
    ...
    public void testGzipAndBrCompressedFiles() throws Exception {
        ...
        try {
            File tempDir = new File(System.getProperty("java.io.tmpdir"), "justsimple_gzip_test_" + System.currentTimeMillis());
            tempDir.mkdirs();
