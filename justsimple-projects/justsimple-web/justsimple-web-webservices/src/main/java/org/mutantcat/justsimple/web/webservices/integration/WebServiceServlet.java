 ...
 */
package org.mutantcat.justsimple.web.webservices.integration;
...
import org.mutantcat.justsimple.web.webservices.WebServiceHelper;
...
public class WebServiceServlet extends CXFNonSpringServlet {
    ...
    private void publishWebService() {
        ...
        WebServiceBeanBuilder wsBeanBuilder = JustSimple.context().getBean(WebServiceBeanBuilder.class);
