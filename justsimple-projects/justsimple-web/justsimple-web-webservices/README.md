...
<dependency>
    ...
    <artifactId>justsimple-web-webservices</artifactId>
</dependency>
```
...
服务端需要与 justsimple.boot.jetty、justsimple.boot.unertow 或者 war 部署方式，配合使用。
...
public class ClientTest {
    public static void main(String[] args) {
        JustSimple.start(ClientTest2.class, args);
    }
}
```
