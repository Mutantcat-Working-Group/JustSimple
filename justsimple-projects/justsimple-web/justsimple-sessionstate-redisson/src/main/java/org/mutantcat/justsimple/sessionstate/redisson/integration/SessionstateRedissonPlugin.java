 ...
 */
package org.mutantcat.justsimple.sessionstate.redisson.integration;

import org.mutantcat.justsimple.core.AppContext;
import org.mutantcat.justsimple.core.Plugin;
import org.mutantcat.justsimple.sessionstate.redisson.RedissonSessionStateFactory;
...
public class SessionstateRedissonPlugin implements Plugin {
    ...
    public void start(AppContext context) {
        ...
        context.app().chains().setSessionStateFactory(RedissonSessionStateFactory.getInstance());
