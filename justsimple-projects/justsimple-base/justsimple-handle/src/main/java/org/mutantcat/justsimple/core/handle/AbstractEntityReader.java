...
import org.mutantcat.justsimple.core.exception.ConstructionException;
import org.mutantcat.justsimple.core.exception.StatusException;
import org.mutantcat.justsimple.core.util.ClassUtil;
import org.mutantcat.justsimple.core.util.ConvertUtil;
    ...
    protected Object doReadArgument(Context ctx, Object target, MethodWrap mWrap, ParamWrap pWrap, int pIndex, LazyReference bodyRef) throws Throwable {
        ...
        if (tv == null) {
            if (JustSimple.app() != null) {
                MethodArgumentResolver argumentResolver = JustSimple.app().chains().getArgumentResolver(ctx, pWrap);
