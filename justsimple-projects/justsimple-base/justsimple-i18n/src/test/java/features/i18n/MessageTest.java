...
public class MessageTest {
    @Test
    public void test() {
        String text = I18nUtil.getMessage(JustSimple.cfg().locale(), "login.title");
        System.out.println(JustSimple.cfg().locale() + ": " + text);

        text = I18nUtil.getMessage(JustSimple.cfg().locale(), "login.title");
        System.out.println(JustSimple.cfg().locale() + ": " + text);
    ...
    @Test
    public void test2() {
        Map map = I18nUtil.getMessageBundle(JustSimple.cfg().locale()).toProps();
        assert map.size() == 2;
