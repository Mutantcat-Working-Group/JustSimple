 ...
 */
package org.mutantcat.justsimple.i18n.impl;
...
import org.mutantcat.justsimple.i18n.LocaleUtil;
...
public class LocaleResolverCookie implements LocaleResolver {
    private String cookieName = "JUSTSIMPLE.LOCALE";
    ...
    public Locale getLocale(Context ctx) {
        if (ctx.getLocale() == null) {
            ...
            if (Utils.isEmpty(lang)) {
                ctx.setLocale(JustSimple.cfg().locale());
            } else {
