 ...
 */
package org.mutantcat.justsimple.proxy;
...
import org.mutantcat.justsimple.proxy.aot.AotProxy;
import org.mutantcat.justsimple.proxy.asm.AsmProxy;
...
public class ProxyUtil {
    ...
    public static <T> T newProxyInstance(Class<T> clazz, InvocationHandler handler) {
        return newProxyInstance(JustSimple.context(), clazz, handler);
    }
