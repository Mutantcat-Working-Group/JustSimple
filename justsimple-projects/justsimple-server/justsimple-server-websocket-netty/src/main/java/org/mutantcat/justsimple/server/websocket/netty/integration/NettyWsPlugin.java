 ...
 */
package org.mutantcat.justsimple.server.websocket.netty.integration;
...
import org.mutantcat.justsimple.server.websocket.netty.NettyWsServer;
...
public class NettyWsPlugin implements Plugin {
    ...
    public static String justsimple_server_ver() {
        return "netty-webscoket 4.1.75/" + JustSimple.version();
    }
    ...
    private void start0(AppContext context) throws Throwable {
        ...
        log.info("Server:main: netty-websocket: Started (" + justsimple_server_ver() + ") @" + (time_end - time_start) + "ms");
    }
    ...
    public void stop() throws Throwable {
        ...
        log.info("Server:main: netty-webscoket: Has Stopped (" + justsimple_server_ver() + ")");
    }
}
