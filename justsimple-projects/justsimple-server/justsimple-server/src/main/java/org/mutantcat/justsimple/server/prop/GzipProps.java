...
public class GzipProps {
    ...
    public static void load() {
        ...
        enable = JustSimple.cfg().getBool(ServerConstants.SERVER_HTTP_GZIP_ENABLE, false);
        minSize = JustSimple.cfg().getLong(ServerConstants.SERVER_HTTP_GZIP_MINSIZE, 4096);
        JustSimple.cfg().find(ServerConstants.SERVER_HTTP_GZIP_MIMETYPES + ".", (key, val) -> {
