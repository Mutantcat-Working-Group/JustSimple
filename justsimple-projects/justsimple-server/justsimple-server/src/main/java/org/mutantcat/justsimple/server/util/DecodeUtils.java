...
import org.mutantcat.justsimple.server.http.HttpPartFile;
import org.mutantcat.justsimple.server.io.LimitedInputException;
import org.mutantcat.justsimple.server.io.LimitedInputStream;
import org.mutantcat.justsimple.server.http.uploadfile.HttpMultipart;
import org.mutantcat.justsimple.server.http.uploadfile.HttpMultipartCollection;
...
public class DecodeUtils {
    ...
    public static void decodeMultipart(Context ctx, InputStream unlimitedInputStream, MultiMap<UploadedFile> filesMap) {
        try {
            ...
            // 修复：multipart 解析异常时清理已构建的上传临时文件，避免畸形请求持续遗留 justsimple.*.tmp 耗尽磁盘
