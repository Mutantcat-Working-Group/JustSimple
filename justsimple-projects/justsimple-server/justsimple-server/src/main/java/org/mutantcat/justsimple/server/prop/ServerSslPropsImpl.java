 ...
 */
package org.mutantcat.justsimple.server.prop;
...
class ServerSslPropsImpl implements ServerSslProps {
    ...
    public ServerSslPropsImpl(String signalName) {
        ...
        enable = JustSimple.cfg().getBool(PROP_SSL_ENABLE, true);
        sslKeyStore = JustSimple.cfg().getByKeys(PROP_SSL_KEY_STORE, ServerConstants.SERVER_SSL_KEY_STORE);
        ...
        sslTrustStore = JustSimple.cfg().getByKeys(PROP_SSL_TRUST_STORE, ServerConstants.SERVER_SSL_TRUST_STORE);
        if (Utils.isNotEmpty(sslTrustStore)) {
            ...
            sslTrustStoreType = JustSimple.cfg().getByKeys(
                    PROP_SSL_TRUST_STORE_TYPE, ServerConstants.SERVER_SSL_TRUST_STORE_TYPE);
            sslTrustStorePassword = JustSimple.cfg().getByKeys(
