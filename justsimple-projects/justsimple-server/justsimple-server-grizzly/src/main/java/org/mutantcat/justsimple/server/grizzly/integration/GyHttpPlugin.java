 ...
 */
package org.mutantcat.justsimple.server.grizzly.integration;
...
import org.mutantcat.justsimple.server.grizzly.GyHttpServer;
...
public class GyHttpPlugin implements Plugin {
    ...
    public static String justsimple_server_ver() {
        return "grizzly http 4.0/" + JustSimple.version();
    }
    ...
    private void start0(AppContext context) throws Throwable {
        ...
        String connectorInfo = "justsimple.connector:main: grizzlyhttp: Started ServerConnector@{HTTP/1.1,[http/1.1]";
        ...
        log.info("Server:main: grizzlyhttp: Started (" + justsimple_server_ver() + ") @" + (time_end - time_start) + "ms");
    }
    ...
    public void stop() throws Throwable {
        if (_server != null) {
            ...
            log.info("Server:main: grizzlyhttp: Has Stopped (" + justsimple_server_ver() + ")");
        }
    }
}