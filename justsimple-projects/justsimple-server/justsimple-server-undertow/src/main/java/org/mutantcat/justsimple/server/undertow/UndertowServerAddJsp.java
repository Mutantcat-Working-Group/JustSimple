...
import org.mutantcat.justsimple.server.undertow.jsp.JspResourceManager;
import org.mutantcat.justsimple.server.undertow.jsp.JspServletEx;
...
//        JspServletBuilder.setupDeployment(builder, new HashMap<String, JspPropertyGroup>(), tagLibraryMap, new HackInstanceManager());
    ...
    protected String getResourceRoot() throws FileNotFoundException {
        ...
        if (JustSimple.cfg().isDebugMode() && JustSimple.cfg().isFilesMode()) {
