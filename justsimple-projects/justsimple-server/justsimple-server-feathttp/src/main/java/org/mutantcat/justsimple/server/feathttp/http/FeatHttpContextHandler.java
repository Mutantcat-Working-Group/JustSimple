...
import org.mutantcat.justsimple.server.feathttp.integration.FeatHttpPlugin;
import org.mutantcat.justsimple.server.feathttp.websocket.FeatHttpWebSocketUpgrade;
  ...
  protected void handleDo(FeatHttpContext ctx) {
    try {
      if (ServerProps.output_meta) {
        ctx.headerSet("JustSimple-Server", FeatHttpPlugin.justsimple_server_ver());
      }
