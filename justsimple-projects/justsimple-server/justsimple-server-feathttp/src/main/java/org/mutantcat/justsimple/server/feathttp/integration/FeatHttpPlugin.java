 ...
 */
package org.mutantcat.justsimple.server.feathttp.integration;
...
import org.mutantcat.justsimple.server.feathttp.FeatHttpServerComb;
import org.mutantcat.justsimple.server.feathttp.http.MultipartUtil;
...
public final class FeatHttpPlugin implements Plugin {
    ...
    public static String justsimple_server_ver() {
        return "FeatHttp 2.1/" + JustSimple.version();
    }
    ...
    public void stop() throws Throwable {
        if (_server != null) {
            ...
            log.info("Server:main: feat: Has Stopped (" + justsimple_server_ver() + ")");
        }
    }
    ...
    private void start0(AppContext context) throws Throwable {
        ...
        String connectorInfo =
                "justsimple.connector:main: feat: Started ServerConnector@{HTTP/1.1,[http/1.1]";
