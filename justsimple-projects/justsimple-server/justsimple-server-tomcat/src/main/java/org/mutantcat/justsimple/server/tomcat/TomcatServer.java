 ...
 */
package org.mutantcat.justsimple.server.tomcat;
...
import org.mutantcat.justsimple.server.handle.SessionProps;
import org.mutantcat.justsimple.server.prop.impl.HttpServerProps;
import org.mutantcat.justsimple.server.tomcat.http.TCHttpContextHandler;
import org.mutantcat.justsimple.server.tomcat.ssl.TomcatSslContext;
import org.mutantcat.justsimple.server.tomcat.websocket.TcWebSocketManager;
...
public class TomcatServer extends TomcatServerBase {
    ...
    protected Context initContext() {
        ...
        Wrapper servlet = Tomcat.addServlet(context, "justsimple", new TCHttpContextHandler());
        servlet.setAsyncSupported(true);
        servlet.setMultipartConfigElement(multipartConfig);

        context.addServletMappingDecoded("/", "justsimple");//Servlet与对应uri映射
