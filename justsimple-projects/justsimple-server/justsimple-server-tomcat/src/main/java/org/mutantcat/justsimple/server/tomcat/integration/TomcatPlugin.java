 ...
 */
package org.mutantcat.justsimple.server.tomcat.integration;
...
import org.mutantcat.justsimple.server.tomcat.TomcatServer;
import org.mutantcat.justsimple.server.tomcat.TomcatServerJsp;
...
public final class TomcatPlugin implements Plugin {
    ...
    public static String justsimple_server_ver() {
        return ServerInfo.getServerInfo() + "/" + JustSimple.version();
    }
    ...
    private void start0(AppContext context) throws Throwable {
        ...
        log.info("Server:main: tomcat: Started (" + justsimple_server_ver() + ") @" + (time_end - time_start) + "ms");
    }
    ...
    public void stop() throws Throwable {
        if (_server != null) {
            ...
            log.info("Server:main: tomcat: Has Stopped (" + justsimple_server_ver() + ")");
        }
    }
}