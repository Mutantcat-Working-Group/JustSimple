 ...
 */
package org.mutantcat.justsimple.server.vertx.integration;
...
import org.mutantcat.justsimple.server.vertx.VxHttpServerComb;
...
public class VxHttpPlugin implements Plugin {
    ...
    public static String justsimple_server_ver() {
        return "vertx-http/" + JustSimple.version();
    }
    ...
    private void start0(AppContext context) throws Throwable {
        ...
        String connectorInfo = "justsimple.connector:main: vertx-http: Started ServerConnector@{HTTP/1.1,[http/1.1]";
        ...
        log.info("Server:main: vertx-http: Started (" + justsimple_server_ver() + ") @" + (time_end - time_start) + "ms");
    }
