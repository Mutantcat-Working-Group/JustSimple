 ...
 */
package org.mutantcat.justsimple.server.vertx;

import io.vertx.core.Vertx;
import io.vertx.core.http.HttpServer;
import io.vertx.core.http.HttpServerOptions;
import io.vertx.core.net.JksOptions;
import io.vertx.justsimple.VertxHolder;
...
import org.mutantcat.justsimple.server.vertx.http.VxHandlerSupplier;
import org.mutantcat.justsimple.server.vertx.http.VxHandlerSupplierDefault;
...
import org.mutantcat.justsimple.web.vertx.VxHandler;
...
public class VxHttpServer implements ServerLifecycle {
    ...
    public void start(String host, int port) throws Throwable {
        Vertx _vertx = VertxHolder.getVertx(JustSimple.context());
