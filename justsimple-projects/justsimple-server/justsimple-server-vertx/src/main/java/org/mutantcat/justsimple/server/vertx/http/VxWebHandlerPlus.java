 ...
 */
package org.mutantcat.justsimple.server.vertx.http;

import io.vertx.core.Vertx;
import io.vertx.core.http.HttpServerRequest;
import org.mutantcat.justsimple.Utils;
import org.mutantcat.justsimple.server.ServerProps;
import org.mutantcat.justsimple.server.vertx.integration.VxHttpPlugin;
import org.mutantcat.justsimple.core.handle.Context;
import org.mutantcat.justsimple.server.vertx.websocket.VxWebSocketHandlerImpl;
import org.mutantcat.justsimple.web.vertx.VxWebHandler;
...
public class VxWebHandlerPlus extends VxWebHandler {
    ...
    protected void preHandle(Context ctx) throws IOException {
        if (ServerProps.output_meta) {
            ctx.headerSet("JustSimple-Server", VxHttpPlugin.justsimple_server_ver());
        }
    }
