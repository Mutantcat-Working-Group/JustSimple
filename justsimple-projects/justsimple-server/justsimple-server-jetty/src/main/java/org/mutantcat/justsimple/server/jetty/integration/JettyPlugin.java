 ...
 */
package org.mutantcat.justsimple.server.jetty.integration;
...
import org.mutantcat.justsimple.server.jetty.JettyServer;
import org.mutantcat.justsimple.server.jetty.JettyServerAddJsp;
...
public final class JettyPlugin implements Plugin {
    ...
    public static String justsimple_server_ver() {
        return "jetty 9.4/" + JustSimple.version();
    }
    ...
    private void start0(AppContext context) throws Throwable {
        ...
        log.info("Server:main: jetty: Started (" + justsimple_server_ver() + ") @" + (time_end - time_start) + "ms");
    }
    ...
    public void stop() throws Throwable {
        if (_server != null) {
            ...
            log.info("Server:main: jetty: Has Stopped (" + justsimple_server_ver() + ")");
        }
    }
}
