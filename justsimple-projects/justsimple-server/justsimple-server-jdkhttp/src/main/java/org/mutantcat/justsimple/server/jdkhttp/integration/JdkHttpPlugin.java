 ...
 */
package org.mutantcat.justsimple.server.jdkhttp.integration;

import org.mutantcat.justsimple.JustSimple;
import org.mutantcat.justsimple.server.ServerConstants;
import org.mutantcat.justsimple.server.ServerProps;
import org.mutantcat.justsimple.server.jdkhttp.JdkHttpServerComb;
...
public final class JdkHttpPlugin implements Plugin {
    ...
    public static String justsimple_server_ver() {
        return "jdk http/" + JustSimple.version();
    }
    ...
    public void start(AppContext context) throws Throwable {
        ...
        if (ClassUtil.loadClass("org.mutantcat.justsimple.server.smarthttp.integration.SmHttpPlugin") != null) {
            return;
        }
    ...
    private void start0(AppContext context) throws Throwable {
        ...
        log.info("Server:main: jdkhttp: Started (" + justsimple_server_ver() + ") @" + (time_end - time_start) + "ms");
    }
    ...
    public void stop() throws Throwable {
        ...
        _server.stop();
        _server = null;
        log.info("Server:main: jdkhttp: Has Stopped (" + justsimple_server_ver() + ")");
    }
}
