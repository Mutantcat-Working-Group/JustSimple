 ...
 */
package org.mutantcat.justsimple.aot;
...
import org.mutantcat.justsimple.aot.graalvm.GraalvmUtil;
import org.mutantcat.justsimple.aot.hint.ResourceHint;
import org.mutantcat.justsimple.core.AppContext;
import org.mutantcat.justsimple.core.PluginEntity;
import org.mutantcat.justsimple.core.runtime.NativeDetector;
import org.mutantcat.justsimple.core.util.ClassUtil;
import org.mutantcat.justsimple.core.util.ScanUtil;
...
import org.mutantcat.justsimple.extend.impl.RuntimeServiceExt;
 ...
 */
public class JustSimpleAotProcessor {
    static final Logger log = LoggerFactory.getLogger(JustSimpleAotProcessor.class);
    ...
    public JustSimpleAotProcessor(Settings settings, String[] applicationArgs, Class<?> applicationClass) {
    ...
    public static void main(String[] args) throws Throwable {
        ...
        if (args.length < requiredArgs) {
            throw new IllegalArgumentException("Usage: " + JustSimpleAotProcessor.class.getName()
        ...
        new JustSimpleAotProcessor(build, applicationArgs, application).process();
    }
    ...
    protected RuntimeNativeMetadata genRuntimeNativeMetadata(AppContext context) throws Throwable {
        ...
        List<PluginEntity> plugins = JustSimple.cfg().plugins();
    ...
    /**
     * 添加 resource-config.json，同时将扫描到的文件，写入justsimple-resource.json中，方便 native 模式下，扫描资源
     *
    ...
    private void addResourceConfig(RuntimeNativeMetadata metadata) {
        try {
            ...
            FileWriter justsimpleResourceFile = getFileWriter(GraalvmUtil.JUSTSIMPLE_RESOURCE_NAME);
            justsimpleResourceFile.write(ONode.ofBean(allResources, jsonOptions).toJson());
            justsimpleResourceFile.close();
    ...
    private void addReflectConfig(RuntimeNativeMetadata metadata) {
        try {
            addReflectConfigDo(metadata, "org.mutantcat.justsimple.extend.impl.PropsLoaderExt");
            addReflectConfigDo(metadata, "org.mutantcat.justsimple.extend.impl.PropsConverterExt");
            addReflectConfigDo(metadata, "org.mutantcat.justsimple.extend.impl.AppClassLoaderExt");
            addReflectConfigDo(metadata, "org.mutantcat.justsimple.extend.impl.RuntimeServiceExt");
            addReflectConfigDo(metadata, "org.mutantcat.justsimple.extend.impl.ProxyBinderExt");
            addReflectConfigDo(metadata, "org.mutantcat.justsimple.extend.impl.ActionLoaderFactoryExt");
