...
import org.mutantcat.justsimple.aot.hint.ExecutableMode;
import org.mutantcat.justsimple.aot.hint.MemberCategory;
import org.mutantcat.justsimple.aot.proxy.ProxyClassGenerator;
 ...
 *
 * @author songyinyin
 * @see org.mutantcat.justsimple.aot.graalvm.GraalvmUtil
 * @since 2.2
 */
public class AppContextNativeProcessorDefault implements AppContextNativeProcessor {
    ...
    public static final String AOT_PROXY_CLASSNAME_SUFFIX = "$$JustSimpleAotProxy";
    public static final String ASM_PROXY_CLASSNAME_SUFFIX = "$$JustSimpleAsmProxy";
    ...
    public void process(AppContext context, Settings settings, RuntimeNativeMetadata metadata) throws Throwable {
        ...
        context.aot().getMethodEgggs().forEach(me -> NativeMetadataUtils.registerMethodAndParamAndReturnType(metadata, me));
