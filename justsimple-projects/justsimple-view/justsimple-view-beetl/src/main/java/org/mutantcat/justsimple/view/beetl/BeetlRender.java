 ...
 */
package org.mutantcat.justsimple.view.beetl;
...
public class BeetlRender implements Render {
    ...
    private void forDebug() {
        ...
        try {
            if (dir.exists()) {
                FileResourceLoader loader = new FileResourceLoader(dir.getPath(), JustSimple.encoding());
    ...
    private void forRelease() {
        ...
        try {
            if (ResourceUtil.hasFile(viewPrefix)) {
                ...
                FileResourceLoader loader = new FileResourceLoader(dir.getFile(), JustSimple.encoding());
