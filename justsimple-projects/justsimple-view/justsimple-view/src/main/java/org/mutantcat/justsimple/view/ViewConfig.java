 ...
 */
package org.mutantcat.justsimple.view;
...
public class ViewConfig {
    ...
    public static final String HEADER_VIEW_META = "JustSimple-View";

    private static boolean outputMeta;
    private static String viewPrefix;

    static {
        outputMeta = JustSimple.cfg().getInt("justsimple.output.meta", 0) > 0;
        viewPrefix = JustSimple.cfg().get("justsimple.view.prefix");
