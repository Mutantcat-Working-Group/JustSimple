...
import org.mutantcat.justsimple.shell.core.CommandMetadata;
import org.mutantcat.justsimple.shell.core.ShellReplJansi;
...
/**
 * 命令扫描器（复用 JustSimple Plugin 机制，随 JustSimple 启动执行）
 *
 * @author noear
 * @author shenmk
 * @since 3.9.1
